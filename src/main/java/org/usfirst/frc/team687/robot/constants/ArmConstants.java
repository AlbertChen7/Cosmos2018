...
public class ArmConstants {
    ...
    public static final double kArmP = 0.89
    ;
    public static final double kArmI = 0.0;
    public static final double kArmD = 0.10;
    ;
    public static final double kArmF = 0.0;


    public static final int kArmUpPos = 2402;
    public static final int kArmDownPos = 93;
    public static final int kArmIntakePos = 500;
    ;
